...
int main(int argc, char** argv){
    ...
    double scalex;
    cout<<"Enter the resolution x: ";
    cin>>scalex;
    double scaley;
    cout<<"Enter the resolution y: ";
    cin>>scaley;
    
    Mat fr2;
    
    string flname = "myfile"+to_string(scalex)+","+to_string(scaley)+".txt";
    ofstream outFile;
    outFile.open(flname);
    ...
    resize(empty, empty, Size(scalex,scaley));
    Mat empt,prvs;
    vid>>empt;
    resize(empt, empt,Size(scalex,scaley));
    ...
    for(; ;){
        ...
        Mat fr;
        resize(fr2, fr,Size(scalex,scaley));
        Mat grayA;
